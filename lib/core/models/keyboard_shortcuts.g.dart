...
_$KeyboardShortcutsImpl _$$KeyboardShortcutsImplFromJson(
  ...
  openCommandPalette: json['openCommandPalette'] == null
      ...
      : KeyboardShortcut.fromJson(
          json['openCommandPalette'] as Map<String, dynamic>,
        ),
  ...
  previousMarker: KeyboardShortcut.fromJson(
    json['previousMarker'] as Map<String, dynamic>,
  ),
  ...
  createManualKeyframe: KeyboardShortcut.fromJson(
    json['createManualKeyframe'] as Map<String, dynamic>,
  ),
...
Map<String, dynamic> _$$KeyboardShortcutsImplToJson(
  ...
  'createManualKeyframe': instance.createManualKeyframe,
